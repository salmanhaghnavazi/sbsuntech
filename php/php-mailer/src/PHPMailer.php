...
class PHPMailer
{
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = [
            'authenticate' => 'خطای SMTP: اعتبارسنجی ناموفق بود.',
            'connect_host' => 'خطای SMTP: ارتباط با هاست SMTP ناموفق بود.',
            'data_not_accepted' => 'خطای SMTP: داده قبول نشد.',
            'empty_message' => 'بدنه پیام خالی است',
            'encoding' => 'encoding نامشخص: ',
            'execute' => 'نمی توان اجرا کرد: ',
            'file_access' => 'عدم دسترسی به فایل: ',
            'file_open' => 'خطای فایل: نمی توان فایل را باز کرد: ',
            'from_failed' => 'آدرس فرم مقابل ناموفق بود: ',
            'instantiate' => 'تابع ایمیل را نمی توان اجرا کرد.',
            'invalid_address' => 'آدرس نامعتبر: ',
            'invalid_hostentry' => 'میزبانی نامعتبر: ',
            'invalid_host' => 'میزبان نامعتبر: ',
            'mailer_not_supported' => ' mailer پشتیبانی نمی شود.',
            'provide_address' => 'باید حداقل یک آدرس ایمیل گیرنده مشخص کنید.',
            'recipients_failed' => 'خطای SMTP: گیرنده های مقابل ناموفق بود: ',
            'signing' => 'خطای امضا: ',
            'smtp_connect_failed' => 'SMTP connect() ناموفق بود.',
            'smtp_error' => 'خطای سرور SMTP: ',
            'variable_set' => 'نمی توان متغیر را تنظیم یا بازنشانی کرد: ',
            'extension_missing' => 'Extension موجود نیست: ',
        ];
        if (empty($lang_path)) {
